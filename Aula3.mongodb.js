...
// constante que define nome da coleção do banco de dados
// const collection = 'Livraria';

// Define o banco de dados que será utilizado
use(database);

// Define/cria a coleção de dados que será utilizada
// db.createCollection(collection)

// db['Livraria'].find();


                // Procurando por uma palavra ou letra em especifico

// db['Livraria'].find({'descricao':/robôs/i},{'_id': 0, 'codigo': 0, 'autor': 0})

// ex: '/{palavra procurada]/'
// O sinal 'i' é para ele não diferenciar o maiuscolo do minusculo


                //Atualização de dados (Update-One)
...
// );
                ...
                // Livro exemplo para atulização

// db['Livraria'].find({"titulo":"O Sol Desvelado"});




                //Atualização de dados (Update-Many)
...
// );
                // Livro exemplo para Excluir Um item

// db['Livraria'].find({"codigo": "2"});



                //Deletar dados (Update-Many)

// db['Livraria'].deleteMany(

//     {'autor': 'Isaac Asimov'},

// );
                // Livro exemplo para Excluir Varios
